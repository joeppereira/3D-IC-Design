...
import {
  ...
  wrap_snippet,
  writable
} from "./chunk-Q6KFHUNK.js";
import {
  append,
  comment,
  from_html
} from "./chunk-LJZXQ36M.js";
import {
  FILENAME,
  HMR,
  add_svelte_meta,
...
function useTask(keyOrFn, fnOrOptions, options) {
  ...
  let running = tag(user_derived(() => opts?.running?.() ?? opts?.autoStart ?? true), "running");
  if (opts) {
    if (opts.stage) {
...
//# sourceMappingURL=chunk-KOLTI5CF.js.map
